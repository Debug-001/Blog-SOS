...
const Footer = () => {
    return (
        <footer class="page-footer font-small blue pt-4">
            ...
            <div class="footer-copyright text-center py-1"><h1 style={{ "font-size": "17px", "margin-top": "3rem" }}>Copyright © CHRIST (Deemed to be University) 2020</h1><p>Website developed by <a href="http://ombhatt.com">Om Sharma</a>, <a href="https://samyak003.in">Samyak Jain</a></p>
            </div>
        </footer>
